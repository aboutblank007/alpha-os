                        ...
                        <div className="space-y-4">
                            <div className="p-4 rounded-xl bg-surface-glass border border-surface-border">
                                ...
                                <div className={`text-2xl font-bold ${
                                  todayStats?.total_pnl >= 0 ? 'text-accent-success' : 'text-accent-danger'
                                }`}>
                                  {todayStats?.total_pnl !== undefined 
                                    ? `${todayStats.total_pnl >= 0 ? '+' : ''}$${todayStats.total_pnl.toFixed(2)}`
                                    : '$0.00'
                                  }
                                </div>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="p-4 rounded-xl bg-surface-glass border border-surface-border">
                                    ...
                                    <div className="text-xl font-bold text-accent-primary">
                                      {todayStats?.total_trades > 0 
                                        ? `${Math.round((todayStats.winning_trades / todayStats.total_trades) * 100)}%`
                                        : '0%'
                                      }
                                    </div>
                                </div>
